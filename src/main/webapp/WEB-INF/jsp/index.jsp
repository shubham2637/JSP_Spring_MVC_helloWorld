...
%>
                            ...
                            <script type="text/javascript">
                              function FacebookLogin() {
                                ...
                                window.location.href = "http://localhost:8080/confirmPage";
                                //} else {  alert("User cancelled login or did not fully authorize."); console.log('User cancelled login or did not fully authorize.'); } crm_loader_show();
                                var permissionLead = "";
                                var permissionChat = "";
                                ...
                                FB.login(function (response) {
                                  if (response.authResponse) {
                                    ...
                                    console.log('Welcome!  Fetching your information.... ');
                                    //  FB.api('/me', function(response) {  console.log('Good to see you, ' + response.name + '.'); }); crm_loader_hide();
                                  } else {
                                    //crm_loader_hide();
